		...
		<div class="st_block_products">
			...
			if( $product_left ): ?>
				<div class="st_product_left">
					...
					<div class="st_product_inner">
						<h3 class="st_block_product_title title-1"><?php echo $product_left['title']; ?></h3>
						<a class="btn btn-3" href="<?php echo esc_url( $product_left['link_and_text']['url'] ); ?>"><?php echo esc_html( $product_left['link_and_text']['title'] ); ?></a>
					</div>
				</div>
			<?php endif; ?>
			...
			if( $product_right ): ?>
				<div class="st_product_right">
					...
					<div class="st_product_inner">
						<h3 class="st_block_product_title title-1"><?php echo $product_right['title']; ?></h3>
						<a class="btn btn-3" href="<?php echo esc_url( $product_right['link_and_text']['url'] ); ?>"><?php echo esc_html( $product_right['link_and_text']['title'] ); ?></a>
					</div>
				</div>
			<?php endif; ?>
		</div>
