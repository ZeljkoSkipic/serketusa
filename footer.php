		...
		<div class="footer_inner c-wide">
			<div class="col"> <!-- Logo and Info -->
				...
				<div class="socials">
					...
					<a href="<?php echo get_field('instagram', 'option'); ?>" target="_blank" aria-label="Instagram">
					...
					<a href="<?php echo get_field('linkedin', 'option'); ?>" target="_blank" aria-label="LinkedIn">
					...
					<a href="<?php echo get_field('twitter', 'option'); ?>" target="_blank" aria-label="Twitter">
			...
			<div class="col"> <!-- Apparel Menu -->
				<h4><?php echo get_field('col_2_menu_title', 'option'); ?></h4>
				<?php
				wp_nav_menu(
					array(
			...
			<div class="col"> <!-- Equipment Menu -->
				<h4><?php echo get_field('col_3_menu_title', 'option'); ?></h4>
				<?php
				wp_nav_menu(
					array(
			...
			<div class="col"> <!-- About Menu -->
				<h4><?php echo get_field('col_4_menu_title', 'option'); ?></h4>
				<?php
				wp_nav_menu(
					array(
